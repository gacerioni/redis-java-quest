...
public final class LessonCheck implements Check {
    ...
    public void run(Ctx ctx, Verdict v) {
        ...
        try (RedisClient jedis = Clients.jedis()) {
            ...
            if (jedisRan && !lettuceRan) v.info("Opcional: experimente com o Lettuce: ./quest run 101-03 lettuce");
            if (lettuceRan && !jedisRan) v.info("Opcional: experimente com o Jedis: ./quest run 101-03 jedis");
