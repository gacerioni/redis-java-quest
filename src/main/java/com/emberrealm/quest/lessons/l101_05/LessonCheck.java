...
public final class LessonCheck implements Check {
    ...
    public void run(Ctx ctx, Verdict v) {
        ...
        try (RedisClient jedis = Clients.jedis()) {
            ...
            else if (ranJedis) v.skip("falta experimentar com o Lettuce: ./quest run 101-05 lettuce");
            else if (ranLettuce) v.skip("falta experimentar com o Jedis: ./quest run 101-05 jedis");
        }
    }
}
