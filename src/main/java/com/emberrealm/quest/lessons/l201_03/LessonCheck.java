    ...
    public void run(Ctx ctx, Verdict v) {
        ...
        try (RedisClient jedis = Clients.jedis()) {
            ...
            if (!marker.isEmpty()) {
                ...
                if (jedisRan && !lettuceRan) v.skip("falta experimentar com o Lettuce: ./quest run 201-03 lettuce");
                if (lettuceRan && !jedisRan) v.skip("falta experimentar com o Jedis: ./quest run 201-03 jedis");
