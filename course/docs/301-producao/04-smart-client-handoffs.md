...
O Redis Cloud atualiza versão e troca nós por baixo do seu banco sem pedir licença, e a raid não pode cair por isso. Smart client handoffs (SCH) é o servidor avisando o client, segundos antes, que um shard vai se mover: o client relaxa o timeout dos comandos enquanto dura a manutenção e reconecta no endpoint novo antes do corte, sem perder o que estava na fila. O Lettuce 7 faz isso sozinho em RESP3; o Jedis 8.0.1 ainda não, e esta lição mostra o que ele oferece no lugar.
