    ...
    public void run(Ctx ctx, Verdict v) {
        ...
        try (RedisClient jedis = Clients.jedis()) {
            ...
            if (!marker.isEmpty()) {
                ...
                if (jedisRan && !lettuceRan) v.info("Opcional: experimente com o Lettuce: ./quest run 201-04 lettuce");
                if (lettuceRan && !jedisRan) v.info("Opcional: experimente com o Jedis: ./quest run 201-04 jedis");
