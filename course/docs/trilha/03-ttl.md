...
<p class="lesson-meta">Ao vivo · 18-30 min · <a href="../../fundamentos/04-chaves-ttl-scan/">versão completa</a></p>
...
**2. Para acompanhar os demais comandos, rode o lab e confira:**
...
E no fim o lab percorre suas chaves `quest:*` com `SCAN`; página por página, limitando o trabalho de cada chamada. `KEYS` faz a mesma busca em uma execução só e bloqueia o banco inteiro: só em desenvolvimento.
...
??? tip "Para ir além"
    ...
    - Use o prefixo mostrado pelo `doctor` nos comandos manuais desta página.
