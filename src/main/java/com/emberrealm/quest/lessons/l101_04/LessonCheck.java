...
public final class LessonCheck implements Check {
    ...
    public void run(Ctx ctx, Verdict v) {
        ...
        try (RedisClient jedis = Clients.jedis()) {
            ...
            else if (ranJedis) v.info("Opcional: experimente com o Lettuce: ./quest run 101-04 lettuce");
            else if (ranLettuce) v.info("Opcional: experimente com o Jedis: ./quest run 101-04 jedis");
        }
    }
}
